...
const JSC_NOT_WORKING_MATHRANDOM_STANDALONE = [0.46386126152939966, 0.5974321089613381, 0.22476738498765259, 0.3323801690684518];
const JSC_SHOULD_WORK_MATHRANDOM_STANDALONE = [0.41815411750722586, 0.7314649296969568, 0.3454368329795394, 0.9112504409932133];
const JSC_SHOULD_WORK_ARRAY_FROM = [0.6806781919543583, 0.2729841437765109, 0.4979057943189942, 0.23591014421734935];

const SAFARI_SEQ_ARRAY_FROM = [0.19185124197715042, 0.8985472408813078, 0.5599842388480063, 0.2118576120390363];
const SAFARI_EXP_ARRAY_FROM = [
  0.8940885882122079, 0.2493513105099956, 0.17384838449194506, 0.34163236306117595, 0.3700342975010623, 0.9981622912650983, 0.9828884378184196,
  0.8475387531835893, 0.42545193115155655, 0.4516730839312372,
];
...
async function Main() {
  ...
  const pred = new SafariRandomnessPredictor(SAFARI_SEQ_ARRAY_FROM);
  for (let i = 0; i < 10; i++) {
