...
import { InsufficientSequenceLengthError } from "../errors.js";
...
// Since the only difference in our Safari strategies are the symbolic & concrete XOR shifts,
...
const SAFARI_STRATEGIES: SolvingStrategy[] = [
